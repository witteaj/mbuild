...
################### if we end up making bilayer builder a separate package, make a monolayer consisting
################### of a mix of alc, dspc, ffa instead of mixed_bilayer for a hierarchy.
...
class TestCompound(BaseTest):
    ...
    def test_my_label_parmed(self, alc):
        ...
        # is relevant for particles. revisit
        pass
